...
import BotaoInicio from "../components/BotaoIncio";
...
function PaginaDetalheCarta(props) {
    return (
        <>
            ...
            <ContainerDetalhes>
                <ImagemDetalhes src={props.detalheCarta.image} alt="Minha Figura" />
